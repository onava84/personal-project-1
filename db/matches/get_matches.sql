...
select m.match_id, m.match_date, m.match_time, m.referee_id, r.referee_name, f.field_name, m.week_playing, m.team_1, t.team_name as team_1_name, m.team_2, t2.team_name as team_2_name, m.tournament_id, tour.tournament_name, tour.teams_number from matches as m
join teams as t
on m.team_1 = t.team_id
join teams as t2
on m.team_2 = t2.team_id
